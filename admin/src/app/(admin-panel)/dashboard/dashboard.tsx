      ...
      <div className="flex flex-col   mb-4">
        <div className="p-4 flex flex-col items-center justify-between gap-5">
          ...
          <div className="flex items-center justify-between w-full gap-3">
            <Card className="flex justify-between w-full h-36">
              <div className="flex items-center justify-start pl-6 ">
                ...
                <CardHeader className="">
                  <CardDescription className="">Total Quote</CardDescription>
                  <CardTitle className="">{counts.totalQuotes}</CardTitle>
                </CardHeader>
              </div>
            </Card>
            ...
            <Card className="flex justify-between w-full h-36">
              <div className="flex items-center justify-start pl-6 ">
                <div className="bg-[#FFF3DB] rounded-sm h-8 w-8 flex justify-center items-center">
                  <ClipboardCheck size={20} color="#FFAA00" />
                </div>
                <CardHeader className="">
                  <CardDescription className="">Pending Quotes</CardDescription>
                  <CardTitle className="">{counts.pendingQuotes || 0}</CardTitle>
                </CardHeader>
              </div>
            </Card>
            ...
            <Card className="flex justify-between w-full h-36">
              <div className="flex items-center justify-start pl-6 ">
                ...
                <CardHeader className="">
                  <CardDescription className="">Approved Quotes</CardDescription>
                  <CardTitle className="">{counts.approvedQuotes || 0}</CardTitle>
                </CardHeader>
              </div>
            </Card>
            ...
            <Card className="flex justify-between w-full h-36">
              <div className="flex items-center justify-start pl-6 ">
                <div className="bg-[#FFE0E0] rounded-sm h-8 w-8 flex justify-center items-center">
                  <UsersRound size={20} color="#FF4444" />
                </div>
                <CardHeader className="">
                  <CardDescription className="">Rejected Quotes</CardDescription>
                  <CardTitle className="">{counts.rejectedQuotes || 0}</CardTitle>
                </CardHeader>
              </div>
            </Card>
          </div>
