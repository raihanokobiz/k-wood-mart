  ...
  return (
    <div className="relative w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        {/* Left Image - Chair */}
        <Link href={`curtains?subcategory=${twoData?.data[0]?.slug}`} className="relative w-full h-[50vh] md:h-[80vh] 2xl:h-[800px] overflow-hidden block">
          <motion.div
        ...
        {/* Right Image - Table */}
        <Link href={`curtains?subcategory=${twoData?.data[1]?.slug}`} className="relative w-full h-[50vh] md:h-[80vh] 2xl:h-[800px] overflow-hidden block">
          <motion.div
            className="relative w-full h-[50vh] md:h-[80vh] 2xl:h-[800px] overflow-hidden"
            initial={{ opacity: 0 }}
