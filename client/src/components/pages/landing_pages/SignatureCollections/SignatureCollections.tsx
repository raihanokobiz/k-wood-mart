...
export default async function SignatureCollections() {
  ...
  return (
    <section className="Container">
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8 text-center mb-8">
        ...
        <div className="col-span-2 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4">
          {data?.slice(0, 6).map((collection: Collection, idx: number) => {
            ...
            return (
              ...
              >
                <div className="relative overflow-hidden rounded-md shadow-md hover:shadow-xl transition-all duration-300">
                  {/* Image Container */}
