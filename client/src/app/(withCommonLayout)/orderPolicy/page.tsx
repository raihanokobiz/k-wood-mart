            ...
            <div className="space-y-8">
              <section>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1">
                  ...
                  <ol>Delivery Fee:</ol>
                  <li>Inside Dhaka – Contact us for delivery charge</li>
                  <li>Dhaka Suburb – Contact us for delivery charge</li>
                  <li>Outside Dhaka – Contact us for delivery charge</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1">
                  ...
                  <li>Delivery Fee:Contact us for delivery charge</li>
