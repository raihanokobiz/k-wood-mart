...
export default function HatilFilterSystem({ products }) {
    ...
    useEffect(() => {
        ...
        const childCats = searchParams.get("childCategory")?.split(",").filter(Boolean) || [];
                    ...
                    <div className="flex-1">
                        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            {products?.result?.map((product) => (
                                ...
                                >
                                    <div className="relative h-40 md:h-60 2xl:h-[500px] mb-3">
                                        <Image
                                    ...
                                    <div className="p-4 flex justify-between items-center">
                                        <h3 className=" text-lg lg:text-2xl font-medium text-black">{product?.name}</h3>
