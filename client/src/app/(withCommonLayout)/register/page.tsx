...
const Registration = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-center py-20 lg:mt-14 mt-14">
        <div className="w-[350px] lg:w-[600px]">
          ...
          >
            ...
            <button
              ...
              className={`bg-[#D4A373] hover:bg-[#CCD5AE] duration-300 text-white font-bold py-1.5 rounded-md cursor-pointer ${isSubmitting ? "opacity-50 cursor-not-allowed" : ""
                }`}
            >
